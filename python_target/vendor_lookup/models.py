...
class VendorDetail(BaseModel):
    ...
    name1: str = Field(max_length=80, description="Name line 1 (NAME1)")
    name2: Optional[str] = Field(default=None, max_length=80, description="Name line 2 (NAME2)")
    street: Optional[str] = Field(default=None, max_length=120, description="Street address (STRAS)")
    ...
    email: Optional[str] = Field(
        default=None, max_length=255, description="Email address (ADR6-SMTP_ADDR)"
    )
...
class PurchaseOrderItem(BaseModel):
    ...
    short_text: Optional[str] = Field(
        default=None, max_length=255, description="Item short text (TXZ01)"
    )
